<template>
    ...
    <aside class="sidebar">
        ...
        <div class="side-wrapper">
            ...
            <div class="side-menu">
                <router-link class="sidebar-link" to="/dashboard" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Dashboard">
                ...
                <router-link class="sidebar-link" to="/marketplace" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Marketplace">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <router-link class="sidebar-link" to="/exchange" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Exchange">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <router-link class="sidebar-link trending" to="/my-asset" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="My Asset">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <router-link class="sidebar-link" to="/order-history" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Order History">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
        ...
        <div class="side-wrapper">
            ...
            <div class="side-menu">
                <router-link class="sidebar-link" to="/settings" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Settings">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <router-link class="sidebar-link" to="/identification" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Identification">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <router-link class="sidebar-link" to="/security" active-class="is-active" tabindex="0" data-bs-toggle="popover"
                    data-bs-trigger="hover focus" data-bs-content="Security">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
