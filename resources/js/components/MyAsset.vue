      ...
      <div class="d-flex flex-column animation-element">
        <div class="wrapper pb-2">
          ...
          <div class="card-bs p-3 p-sm-4 animation-element">
            ...
            <div class="d-sm-flex flex-row justify-content-between gap-2 mb-4">
              ...
              <div class="mt-4">
                <div class="d-sm-flex flex-row justify-content-end gap-2">
                  <a class="btn btn-editor btn-primary mb-2" href="#!" data-bs-toggle="modal"
                    data-bs-target="#depositCrypto">Deposit Crypto</a>
                  <a class="btn btn-editor btn-info mb-2" href="#!" data-bs-toggle="modal"
                    data-bs-target="#withdrawModal">Withdraw</a>
                  <a class="btn btn-editor btn-danger mb-2" href="#!" data-bs-toggle="modal"
                    data-bs-target="#convertCrypto">Convert</a>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade show active" id="popular-asset-tab-pane" role="tabpanel"
              aria-labelledby="popular-asset-tab" tabindex="0">
